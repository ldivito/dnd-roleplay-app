...
const mockNPCs: NPC[] = [
  {
    ...
    level: 3,
    background: 'Soldado',
    alignment: { law: 'chaotic', good: 'evil' },
    npcType: 'enemy',
    importance: 'minor',

    // Character inherited fields
    abilityScores: {
      strength: 16,
      dexterity: 12,
      constitution: 16,
    ...
    personality: {
      personality: {
        traits: ['Agresivo', 'Brutal'],
        ideals: ['La fuerza lo es todo'],
        bonds: ['Su tribu'],
        flaws: ['Demasiado confiado'],
        mannerisms: ['Gruñe cuando está molesto'],
        appearance: 'Orco musculoso con cicatrices de batalla',
      },
      goals: ['Demostrar su fuerza'],
      secrets: [],
      fears: ['La magia'],
    },
    isAlive: true,
    ...
    spells: [],
    notes:
      'Enemigo común en combate. Hacha de Batalla: +5 para golpear, 1d12+3 daño cortante',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
]
