      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Biblioteca completa de hechizos, objetos mágicos y conocimiento
            arcano para tu campaña.
          </p>
        </div>
          ...
          <Card className="group hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-sm">
                ...
                musical. Crea hechizos que se lanzan a través de
                interpretaciones musicales con diferentes instrumentos y
                géneros.
              </p>
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950/30 dark:to-blue-950/30 border-purple-200 dark:border-purple-800">
          ...
          <CardContent>
            <p className="text-sm mb-4">
              Experimenta un sistema de magia único donde los hechizos se lanzan
              a través de interpretaciones musicales. Cada instrumento y género
